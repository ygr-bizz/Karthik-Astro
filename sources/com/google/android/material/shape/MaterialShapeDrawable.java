...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public boolean getPadding(Rect padding2) {
        Rect rect = this.padding;
        if (rect == null) {
            return super.getPadding(padding2);
        }
        padding2.set(rect);
        return true;
    }
    ...
    private int compositeElevationOverlayIfNeeded(int backgroundColor) {
    ...
    private void drawCompatShadow(Canvas canvas) {
        ...
        int index2 = getShadowOffsetX();
        int shadowOffsetY = getShadowOffsetY();
        canvas.translate((float) (-index2), (float) (-shadowOffsetY));
    ...
    private android.graphics.PorterDuffColorFilter calculatePaintColorTintFilter(android.graphics.Paint r5, boolean r6) {
        /*
            r4 = this;
    ...
    private RectF getBoundsInsetByStroke() {
        RectF rectF2 = getBoundsAsRectF();
        float inset = getStrokeInsetLength();
        this.insetRectF.set(rectF2.left + inset, rectF2.top + inset, rectF2.right - inset, rectF2.bottom - inset);
