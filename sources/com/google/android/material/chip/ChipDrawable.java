...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private boolean onStateChange(int[] chipState, int[] closeIconState) {
        ...
        int newChipSurfaceColor = colorStateList != null ? colorStateList.getColorForState(iArr, this.currentChipSurfaceColor) : 0;
        if (this.currentChipSurfaceColor != newChipSurfaceColor) {
            this.currentChipSurfaceColor = newChipSurfaceColor;
            invalidate = true;
        }
        ColorStateList colorStateList2 = this.chipBackgroundColor;
        int newChipBackgroundColor = colorStateList2 != null ? colorStateList2.getColorForState(iArr, this.currentChipBackgroundColor) : 0;
