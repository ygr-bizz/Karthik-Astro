...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public void setSelection(Pair<Long, Long> selection) {
        ...
        if (selection.first == null) {
            ...
            l = Long.valueOf(UtcDates.canonicalYearMonthDay(((Long) selection.first).longValue()));
        }
        this.selectedStartItem = l;
        if (selection.second != null) {
            l2 = Long.valueOf(UtcDates.canonicalYearMonthDay(((Long) selection.second).longValue()));
        }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, OnSelectionChangedListener<Pair<Long, Long>> listener) {
        ...
        String textInputHint = UtcDates.getTextInputHint(root.getResources(), format);
        ...
        AnonymousClass1 r0 = new DateFormatTextWatcher(textInputHint, format, startTextInput, calendarConstraints) {
        ...
        endEditText2.addTextChangedListener(new DateFormatTextWatcher(textInputHint, format2, endTextInput, calendarConstraints) {
            /* access modifiers changed from: package-private */
            public void onValidDate(Long day) {
