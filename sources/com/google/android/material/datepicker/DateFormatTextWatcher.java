...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        try {
            ...
            String useLine = String.format(this.textInputLayout.getContext().getString(R.string.mtrl_picker_invalid_format_use), new Object[]{this.formatHint});
            String exampleLine = String.format(this.textInputLayout.getContext().getString(R.string.mtrl_picker_invalid_format_example), new Object[]{this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))});
