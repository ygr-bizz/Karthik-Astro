...
public class Client_hora extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_client_hora);
        ...
        try {
            List<HashMap<String, String>> data = this.controller.getAllPlace_Hora();
            if (data.size() != 0) {
    ...
    public boolean onContextItemSelected(MenuItem menuItem) {
        ...
        ArrayList<HashMap<String, String>> selectAllIds_Hora = this.controller.selectAllIds_Hora();
        this.myIds = selectAllIds_Hora;
        int id = Integer.parseInt((String) selectAllIds_Hora.get(info.position).get("id"));
