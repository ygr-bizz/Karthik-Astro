...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(android.content.Context r19, android.content.res.Resources r20, android.util.TypedValue r21, int r22, int r23, androidx.core.content.res.ResourcesCompat.FontCallback r24, android.os.Handler r25, boolean r26) {
        ...
        L_0x0034:
            return r6
        L_0x0035:
            java.lang.String r0 = r8.toLowerCase()     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00b8 }
            java.lang.String r1 = ".xml"
            boolean r0 = r0.endsWith(r1)     // Catch:{ XmlPullParserException -> 0x00d3, IOException -> 0x00b8 }
            if (r0 == 0) goto L_0x0094
            android.content.res.XmlResourceParser r0 = r9.getXml(r11)     // Catch:{ XmlPullParserException -> 0x008d, IOException -> 0x0086 }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = androidx.core.content.res.FontResourcesParserCompat.parse(r0, r9)     // Catch:{ XmlPullParserException -> 0x008d, IOException -> 0x0086 }
            r17 = r1
        ...
        L_0x0065:
            ...
            r10 = r8
            r8 = r26
            android.graphics.Typeface r1 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x0082, IOException -> 0x007e }
            return r1
        L_0x007e:
            r0 = move-exception
            r1 = r19
        ...
        L_0x0094:
            ...
            r10 = r8
            r1 = r19
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r9, r11, r10, r12)     // Catch:{ XmlPullParserException -> 0x00b4, IOException -> 0x00b0 }
            r6 = r0
