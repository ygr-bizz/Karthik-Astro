        ...
        if (name.equals("gradient")) {
            ...
            if (type == 1) {
                ...
                if (gradientRadius > 0.0f) {
                    ...
                    return new RadialGradient(centerX2, centerY2, gradientRadius, iArr, colorStops.mOffsets, parseTileMode(tileMode));
                }
                ...
                float f2 = centerX;
                return new LinearGradient(startX, startY, endX, endY, iArr3, colorStops.mOffsets, parseTileMode(tileMode));
            } else {
