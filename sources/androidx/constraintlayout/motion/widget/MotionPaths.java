...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void getRect(int[] toUse, double[] data, float[] path, int offset) {
        ...
        if (0.0f != 0.0f) {
            ...
            float f7 = x1;
            float f8 = y1;
            float tx1 = xRotate(sin, cos, f5, f6, f7, f8);
            float ty1 = yRotate(sin, cos, f5, f6, f7, f8);
            float f9 = x2;
            float f10 = y2;
            float tx2 = xRotate(sin, cos, f5, f6, f9, f10);
            float ty2 = yRotate(sin, cos, f5, f6, f9, f10);
            float f11 = x3;
            float f12 = y3;
            float tx3 = xRotate(sin, cos, f5, f6, f11, f12);
            float ty3 = yRotate(sin, cos, f5, f6, f11, f12);
            float f13 = x4;
            float f14 = y4;
            x1 = tx1;
            y1 = ty1;
            ...
            x3 = tx3;
            y3 = ty3;
            x4 = xRotate(sin, cos, f5, f6, f13, f14);
            y4 = yRotate(sin, cos, f5, f6, f13, f14);
        } else {
            float f15 = v_y;
            float f16 = v_width;
        }
