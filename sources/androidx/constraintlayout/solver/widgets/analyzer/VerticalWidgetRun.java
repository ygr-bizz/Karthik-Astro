...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public void update(Dependency dependency) {
        int i = AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$analyzer$WidgetRun$RunType[this.mRunType.ordinal()];
        if (i == 1) {
        ...
        if (this.dimension.readyToSolve && !this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            int i2 = this.widget.mMatchConstraintDefaultHeight;
            if (i2 == 2) {
            ...
            } else if (i2 == 3 && this.widget.horizontalRun.dimension.resolved) {
                int size = 0;
