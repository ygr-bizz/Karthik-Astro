    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i6 = 0; i6 < size2; i6++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), BasicMeasure.EXACTLY), this.mChildHeightMeasureSpec);
            }
        }
    }
                ...
                if (!lp2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ...
                        if (lp2.needsMeasure != 0) {
                            ...
                            child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp2.widthFactor), BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, BasicMeasure.EXACTLY));
                        } else {
                            width = width2;
                            paddingLeft = paddingLeft2;
                        }
